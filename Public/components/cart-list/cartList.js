...
//   // Constructor
//   function Item(img, product, price, quantity) {
//     this.img = img;
...
//   obj.setCountForItem = function(product, quantity) {
//     for(let i in cart) {
...
//       + "<input type='number' class='item-count form-control' data-product='" + cartArray[i].product + "' value='" + cartArray[i].quantity + "'>"
...
//   shoppingCart.setCountForItem(product, quantity);
//   displayCart();
// });
...
//       <img class="card-img-top" ng-src="{{item.img}}" alt="{{item.product}}">
//       <div class="card-body">
//         <h5 class="card-title">{{item.product}}</h5>
//         <p class="card-text"><small class="text-muted">Price: $\{{item.price}}</small></p>
//         <a href="#" data-product="cat-food" data-price="5" class="add-to-cart btn btn-primary">Add to cart</a>
//       </div>
//       </div>
